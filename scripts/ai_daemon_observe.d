 ...
 * SIP-on host: NO pid$target probes are used, so it works against arbitrary
 ...
 *     parser surface — those need pid$target and SIP-off.
...
syscall::connect:entry, syscall::connect_nocancel:entry
/pid == $target && arg1 != 0 && arg2 >= 16 && self->fam == 2/
{
...
syscall::connect:entry, syscall::connect_nocancel:entry
/pid == $target && arg1 != 0 && arg2 >= 28 && self->fam == 30/
{
